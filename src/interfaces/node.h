...
#ifndef FARMCOIN_INTERFACES_NODE_H
#define FARMCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a farmcoin node (farmcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // FARMCOIN_INTERFACES_NODE_H
