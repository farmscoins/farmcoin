...
#ifndef FARMCOIN_QT_FARMCOINUNITS_H
#define FARMCOIN_QT_FARMCOINUNITS_H
...
/** Farmcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class FarmcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FarmcoinUnits(QObject *parent);

    /** Farmcoin units.
      @note Source: https://en.farmcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        FMC,
...
typedef FarmcoinUnits::Unit FarmcoinUnit;

#endif // FARMCOIN_QT_FARMCOINUNITS_H
