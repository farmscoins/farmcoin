    ...
    mapper(0)
{
    ...
    ui->farmcoinAtStartup->setToolTip(ui->farmcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->farmcoinAtStartup->setText(ui->farmcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openFarmcoinConfButton->setToolTip(ui->openFarmcoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new FarmcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->farmcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openFarmcoinConfButton_clicked()
{
