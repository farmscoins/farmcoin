 ...
 */
#ifndef FARMCOIN_UTIL_H
#define FARMCOIN_UTIL_H
...
extern const char * const FARMCOIN_CONF_FILENAME;
extern const char * const FARMCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("farmcoin-%s", name);
