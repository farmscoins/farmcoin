...
static void SetupFarmcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " farmcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  farmcoin-tx [options] <hex-tx> [commands]  Update hex-encoded farmcoin transaction\n" +
            "or:     farmcoin-tx [options] -create [commands]   Create hex-encoded farmcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded farmcoin transaction
