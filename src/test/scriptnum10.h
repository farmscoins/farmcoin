...
#ifndef FARMCOIN_TEST_SCRIPTNUM10_H
#define FARMCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Farmcoin Core 0.10.0, for cross-comparison.
 */
public:
