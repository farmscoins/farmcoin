...
#ifndef FARMCOIN_WALLET_WALLET_H
#define FARMCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this farmcoin node, and set to 0 for transactions that were created
...
#endif // FARMCOIN_WALLET_WALLET_H
