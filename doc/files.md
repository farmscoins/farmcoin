...
* farmcoin.conf: contains configuration settings for farmcoind or farmcoin-qt
* farmcoind.pid: stores the process id of farmcoind while running
...
* debug.log: contains debug information and general logging generated by farmcoind or farmcoin-qt
