...
# TestP2PConn: A peer we use to send messages to farmcoind, and store responses.
...
class CompactBlocksTest(FarmcoinTestFramework):
    ...
    # This test actually causes farmcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that farmcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for farmcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # farmcoind will not send blocktxn responses for blocks whose height is
