...
"""Verify that starting farmcoin with -h works as expected."""

from test_framework.test_framework import FarmcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(FarmcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start farmcoin with -h for help text")
        ...
        self.log.info("Start farmcoin with -version for version information")
        ...
        self.log.info("Start farmcoind with -fakearg to make sure it does not start")
