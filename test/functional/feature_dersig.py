...
class BIP66Test(FarmcoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # farmcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and farmcoind produces more specific reject
            # reasons.
